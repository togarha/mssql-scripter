...
SUPPORTED_PLATFORMS = {
    ...
    'macosx_10_11_intel': SQLTOOLSSERVICE_BASE + 'macosx_10_11_intel/' + 'Microsoft.SqlTools.ServiceLayer-osx-x64-net6.0.tar.gz',
    'win_amd64': SQLTOOLSSERVICE_BASE + 'win_amd64/' + 'Microsoft.SqlTools.ServiceLayer-win-x64-net6.0.zip',
}
...
def copy_sqltoolsservice(platform):
    ...
    if not platform or platform not in SUPPORTED_PLATFORMS:
        ...
        print('Please provide a valid platform flag.' +
              '[win_amd64, manylinux1_x86_64, macosx_10_11_intel]')
        sys.exit(1)
